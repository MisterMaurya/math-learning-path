...
<meta name="google-signin-client_id" content="1006673454970-mt8vq5reg8bg65l9ql5odq92hie7s29s.apps.googleusercontent.com">

<title>Sign in | Mathlearningpath.com</title>
...
<link href='https://fonts.googleapis.com/css?family=Nova Slim' rel='stylesheet'>
 ...
 <div class="container" style="margin-top: 40px">
						...
						<fieldset>
							<div class="row">
								<div class="text-center">
									<img class="profile-img" src="<%=request.getContextPath()%>/resources/img/profile1.png" alt="img">
								</div>
							</div>
							<div class="row">
	...
	<h4 class="text-center" style="color: green; font-family:sans-serif">${name} ${success}</h4>
	<div class="text-center">
